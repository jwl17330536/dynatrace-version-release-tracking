# Version Intelligence Sync v11

## Overview

This workflow collects Dynatrace component release and runtime version data, writes normalized lookups, and updates markdown cards on dashboard v11.
...
- [Update Dashboard v11](?task=update_release_dashboard_v11_markdown&tab=input)
...
1. `Workflows`
2. Open `Version Intelligence Sync v11 Markdown Dashboard`
3. `Workflow options`
4. `Trigger`
5. `Inputs`
...
3. Security rule:
   Do not commit or export live values. In v11, placeholder values such as `<SET_PLATFORM_BEARER_TOKEN>` are ignored.

### `releaseDashboardV11Id`

1. Where to set: `Workflow options -> Trigger -> Inputs -> releaseDashboardV11Id`
...
4. Set this to your dashboard UUID after importing `dashboards/release-tracking-dashboard.v11.json` into your tenant. Copy the UUID from the dashboard URL.
...
5. Confirm `releaseDashboardV11Id` points to dashboard v11.
...
Workflow v11 must update dashboard v11 only. For changes, create v11 pair and disable v11 schedule after enabling v11.
