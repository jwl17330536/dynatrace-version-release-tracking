# Version Intelligence Sync v12

## Overview

This workflow collects Dynatrace component release and runtime version data, writes normalized lookups, and updates markdown cards on dashboard v12.
...
- [Update Dashboard v12](?task=update_release_dashboard_v12_markdown&tab=input)
...
1. `Workflows`
2. Open `Version Intelligence Sync v12 Markdown Dashboard`
3. `Workflow options`
4. `Trigger`
5. `Inputs`
...
3. Security rule:
   Do not commit or export live values. In v12, placeholder values such as `<SET_PLATFORM_BEARER_TOKEN>` are ignored.

### `releaseDashboardV12Id`

1. Where to set: `Workflow options -> Trigger -> Inputs -> releaseDashboardV12Id`
...
4. Set this to your dashboard UUID after importing `dashboards/release-tracking-dashboard.v12.json` into your tenant. Copy the UUID from the dashboard URL.
...
5. Confirm `releaseDashboardV12Id` points to dashboard v12.
...
Workflow v12 must update dashboard v12 only. For changes, create v12 pair and disable v12 schedule after enabling v12.
